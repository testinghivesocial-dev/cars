  ...
  document.addEventListener("DOMContentLoaded", function() {
    ...
    fetch("https://lively-chimera-78eaeb.netlify.app/cars.html")
      .then(res => res.text())
      .then(html => {
        ...
        css.rel = "stylesheet";
        css.href = "https://lively-chimera-78eaeb.netlify.app/style.css";
        document.head.appendChild(css);
        console.log("CSS loaded");
        const script = document.createElement("script");
        script.src = "https://lively-chimera-78eaeb.netlify.app/cars.js";
